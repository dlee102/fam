...
기사 퍼블 후 T0(반응일) 종가 매수 → T+N일 종가 매도 수익률이 맞는지 검증
"""
...
def main():
    ...
    print("=" * 80)
    print("시장 평균 팩트 체크: 기사 퍼블 → T0 종가 매수 → T+N 종가 매도")
    print("=" * 80)
    ...
    print("T0(진입일) 정의")
    print("=" * 80)
    print("• 기사 장 마감 전(15:00 이하) 퍼블 → T0 = 퍼블 당일 (당일 종가 매수)")
    print("• 기사 장 마감 후(15:00 초과) 퍼블 → T0 = 다음 거래일 (다음날 종가 매수)")
